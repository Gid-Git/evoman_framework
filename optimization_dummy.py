...
def main():
    ...
    parser.add_argument("--gens", type=int, default=50, help="Number of generations for the genetic algorithm.")
    ...
    parser.add_argument("--enemies", type=int, nargs='+', default=[4], help='List of enemies to fight.')
